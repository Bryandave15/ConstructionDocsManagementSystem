...
@section('content')
<div class="row h-100 w-100" style="justify-content:center;display:flex; background-image: url('https://c7.alamy.com/comp/2BFPCEX/construction-blu…t-on-building-construction-background-2BFPCEX.jpg'); background-size: cover; background-position: center;" id="login-box">
