...
@foreach ($structural_data as $d)
<tr >

    <td>{{ $d->structural_title }}</td>
    <td>{{ $d->structural_code }}</td> 
    <td>{{ $d->location }}</td> 
    <td>{{ $d->trade }}</td> 
...
{
    window.location.href = '/structural-update-form/'+pId 
}
        ...
        $.ajax({
            ...
            success: function(response){
                if (response.success) {
                    ...
                    window.location.href = '/structural';
                } else {
